...
export const services = [
  {
    ...
    file: 'app/main.py',
    lines: [
      'FastAPI REST APIs with async I/O',
      'JWT auth, RBAC & email verification',
      'Built for real, live user traffic',
    ],
  ...
  },
  {
    ...
    file: 'app/models/courses.py',
    lines: [
      'Relational schema design (SQLAlchemy ORM)',
      'One-to-many & many-to-many modeling',
      'Composite constraints & indexing strategy',
    ],
    tags: ['postgres', 'sqlalchemy', 'indexes'],
  },
  {
    icon: 'bolt',
    title: 'Caching & Rate Limiting',
    file: 'app/utils/redis_client.py',
    lines: [
      'Redis-backed rate limiting',
      'Race-condition-safe request throttling',
      'Session & ephemeral state handling',
    ],
    tags: ['redis', 'rate-limiting', 'async'],
  },
  {
    icon: 'layers',
    ...
    lines: [
      'Dockerized services from scratch',
      'Deployed on cloud VMs (Oracle Cloud)',
      'Automatic HTTPS via Caddy',
    ],
    tags: ['docker', 'oracle-cloud', 'caddy'],
  },
  {
    icon: 'card',
    ...
    lines: [
      ...
      'Access gating & webhook verification',
      'Paystack integration',
    ],
    tags: ['paystack', 'webhooks', 'fastapi'],
  },
  {
    icon: 'cap',
    ...
    lines: [
      ...
      'Fundamentals to production systems',
      'Built Logixia Academy\'s own backend',
    ],
